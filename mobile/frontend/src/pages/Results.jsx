  ...
  useEffect(() => {
    const fetchSubmission = async () => {
      try {
        ...
        // Récupérer les détails de la soumission depuis IndexedDB
        const submissionData = await offlineLogic.getSubmissionDetails(submissionId);
        console.log('Submission response:', submissionData);
        setSubmission(submissionData);
      } catch (err) {
        console.error('Error fetching submission:', err);
        setError('Erreur lors du chargement des détails de la soumission: ' + err.message);
      }
    };
